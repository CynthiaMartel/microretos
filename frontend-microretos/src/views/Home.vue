...
<template>
  <div class="min-h-screen bg-[#F8FAFC] overflow-x-hidden font-sans text-[#1F2937] relative flex items-start lg:items-center justify-center p-4 md:p-8 pt-14 md:pt-16 pb-4 md:pb-6">
    ...
    <div class="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-primary-300/15 rounded-full blur-[100px] pointer-events-none transition-opacity duration-1000" :class="isLoaded ? 'opacity-100' : 'opacity-0'"></div>
    <div class="absolute bottom-[-10%] right-[-10%] w-[30vw] h-[30vw] bg-primary-600/10 rounded-full blur-[100px] pointer-events-none transition-opacity duration-1000 delay-300" :class="isLoaded ? 'opacity-100' : 'opacity-0'"></div>
    ...
    <div class="max-w-6xl w-full mx-auto relative z-10">
      ...
      <header class="flex justify-center mb-4 sm:mb-6 md:mb-8 lg:mb-10 transition-all duration-1000 ease-out transform"
        ...
        <div class="inline-flex items-center bg-[#1F2937] py-2 sm:py-3 pr-5 sm:pr-7 md:pr-10 pl-2 sm:pl-4 md:pl-5 rounded-[1.5rem] sm:rounded-[2rem] shadow-lg border border-[#333333]">
          <img src="../assets/logo_colores.png" alt="Logo DuaLab" class="h-10 sm:h-14 md:h-18 lg:h-20 w-auto object-contain relative z-10" style="height: clamp(2.5rem, 5vw, 5rem);" />
          <span class="font-black text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-tighter uppercase text-white relative z-20 ml-1 sm:ml-2">
      ...
      <main class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-14 items-center">
        ...
        <div class="space-y-3 sm:space-y-4 md:space-y-5 text-center md:text-left">
          <div class="transition-all duration-700 delay-150 ease-out transform"
            ...
            <p class="text-sm md:text-base text-gray-500 leading-relaxed font-medium max-w-xl mx-auto md:mx-0">
              DuaLab conecta empresas con alumnado en prácticas. Transformamos necesidades empresariales en <strong class="text-primary-700 font-bold">retos académicos</strong> para impulsar el aprendizaje práctico y descubrir talento emergente.
            </p>
          </div>
          ...
          <div class="flex flex-col sm:flex-row items-center gap-3 pt-1 transition-all duration-700 delay-300 ease-out transform"
            ...
            <button
              ...
              class="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3.5 bg-gradient-to-r from-primary-600 to-primary-400 text-white rounded-full font-black text-sm uppercase tracking-widest shadow-[0_8px_24px_rgba(48,114,170,0.3)] hover:shadow-[0_12px_32px_rgba(48,114,170,0.4)] transition-all duration-300 hover:-translate-y-1 active:scale-95"
            >
        ...
        <div class="relative transition-all duration-1000 delay-500 ease-out transform"
          ...
          <div class="bg-white p-4 sm:p-5 rounded-[1.5rem] sm:rounded-[2rem] shadow-[0_20px_50px_rgb(0,0,0,0.05)] border border-gray-100 relative z-10">
            ...
            <div class="space-y-3">
              <div class="flex gap-3 items-start p-3 rounded-2xl hover:bg-gray-50 transition-colors">
                <div class="bg-empresas text-white w-9 h-9 rounded-xl flex items-center justify-center shrink-0 font-black shadow-md text-sm">1</div>
                <div>
                  <h4 class="font-bold text-empresas text-base">La Empresa propone</h4>
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Identifican una fricción o cuello de botella real en su día a día.</p>
                </div>
              </div>

              <div class="w-0.5 h-3 bg-gradient-to-b from-gray-200 to-administraciones ml-[1.625rem] -my-2 relative z-0"></div>

              <div class="flex gap-3 items-start p-3 rounded-2xl bg-administraciones/10 border border-administraciones/20 relative z-10">
                <div class="bg-administraciones text-white w-9 h-9 rounded-xl flex items-center justify-center shrink-0 font-black shadow-md text-sm">2</div>
                <div>
                  <h4 class="font-bold text-administraciones text-base">La IA lo transforma</h4>
                  <p class="text-sm text-gray-600 leading-relaxed mt-0.5">DuaLab genera un reto académico alineado al currículo oficial.</p>
                </div>
              </div>

              <div class="w-0.5 h-3 bg-gradient-to-b from-administraciones to-alumnos ml-[1.625rem] -my-2 relative z-0"></div>

              <div class="flex gap-3 items-start p-3 rounded-2xl hover:bg-gray-50 transition-colors">
                <div class="bg-alumnos text-white w-9 h-9 rounded-xl flex items-center justify-center shrink-0 font-black shadow-md shadow-alumnos/30 text-sm">3</div>
                <div>
                  <h4 class="font-bold text-alumnos text-base">El Alumnado resuelve</h4>
          ...
          <div class="hidden sm:flex absolute -bottom-3 -right-3 z-20 bg-[#1F2937] text-white p-3 sm:p-4 rounded-2xl shadow-2xl items-center gap-2.5 sm:gap-3 animate-bounce" style="animation-duration: 3s;">
            <div class="bg-administraciones text-white rounded-full p-1.5">
